...
import {clear} from '../../stores/action_type';
class AlreadyBymyself extends React.Component{
    constructor (...args) {
        super(...args)
    ...
    ag () {
        this.props.history.push('/buyFoot');
    }
    render () {
        ...
        return (
            <div className='detail'>
                ...
                <nav>
                    <p>已消费</p>
                    <span><button type='button'>评价</button><button type='button' onClick={()=>{
                        dispatch(clear())
                        this.props.history.push('/buyFoot')
                    }}>再来一单</button></span>
                </nav>
...
export default {
    key: 'alreadyBymyself',
    path: '/alreadyBymyself',
    component: connect(slect)(AlreadyBymyself)
}